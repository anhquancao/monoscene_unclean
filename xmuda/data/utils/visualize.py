...
SEMANTIC_KITTI_COLOR_PALETTE = np.array([
    [0  , 0  , 0, 255],
    [100, 150, 245, 255],
    [100, 230, 245, 255],
    [30, 60, 150, 255],
...
def draw_points_image_labels(
    img, img_indices, img_name,
    seg_labels, show=False, save_fig=True,
    color_palette_type='SemanticKITTI', point_size=0.5):
...
def draw_points_image_depth(img, img_indices, img_name, depth, show=False, save_fig=True, point_size=0.5):
...
def draw_bird_eye_view(coords, img_name, full_scale=4096, save_fig=True):
    plt.figure()
