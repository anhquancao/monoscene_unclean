...
class DecoderBN(nn.Module):
    def __init__(self,
                 ...
                 out_feature,
                 use_decoder=True):
#    def __init__(self, num_features=2816, bottleneck_features=2816, out_feature=128):
...
#            self.resize_output_1_8 = nn.Conv2d(80, out_feature * 2, kernel_size=1)
#            self.resize_output_1_16 = nn.Conv2d(224, out_feature * 4, kernel_size=1)
...
#                "1_8": self.resize_output_1_8(x_1_8),
#                "1_16": self.resize_output_1_16(x_1_16),
#                "global": features[-1].reshape(bs, 2560, -1).mean
            }
...
class UEfficientNetEncoder(nn.Module):
    def __init__(self,
        ...
        self.decoder = DecoderBN(out_feature=out_feature,
...
if __name__ == '__main__':
    model = UEfficientNetEncoder.build()
