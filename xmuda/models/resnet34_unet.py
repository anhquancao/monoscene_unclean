...
class UNetResNet34(nn.Module):
    def __init__(self, input_size=3, pretrained=True):
    ...
    def dec_stage(enc_stage, num_concat):
        ...
        out_channels = enc_stage[-1].conv3.out_channels
        conv = nn.Sequential(
...
def test():
    ...
    net = UNetResNet34(pretrained=False, input_size=1)
    net.cuda()
    feats = net(image)
